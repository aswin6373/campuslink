...
class GeminiService {
  ...
  // Transforms Gemini markdown-ish output into a chat-friendly format
  ...
  Future<String> sendMessage(String prompt, String institution) async {
    ...
    try {
      // Fetching institution-specific answers from the backend
      final answersResponse = await ApiClient.get('/api/chatbot/answers');
      final List<dynamic> answers =
          answersResponse is List ? answersResponse : [];
